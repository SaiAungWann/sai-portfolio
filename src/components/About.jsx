    ...
    <div id="about" className="mx-10 my-5 font-serif text-white border-b border-gray-700 pb-2 scroll-mt-24">
      ...
      <div className={` ${isExpanded ? "" : "line-clamp-3"}`}>
        ...
        <p className="mt-5 text-justify">
          Hi, I’m <span className="text-xl font-bold">Sai Aung Wann</span> — with over five years of experience as a Site Engineer in Singapore and Myanmar, with strong involvement in construction coordination and project execution. I am trained in <span className="text-xl font-bold">Building Information Modelling (BIM) </span> and have hands-on experience using <span className="text-xl font-bold">Autodesk Revit and Navisworks Manage</span>, focusing on <span className="text-xl font-bold">Architectural and Structural disciplines</span>. My expertise includes BIM modeling, custom parameter creation, Clash Detction and the development of 4D and 5D simulations and construction animations. I am also familiar with Fuzor for BIM 4D/5D presentation and visualization workflows. Although I currently do not have access to Fuzor due to licensing costs, I have a solid understanding of its functionality and am eager to further enhance my skills.
        </p> <br />
        <p>
